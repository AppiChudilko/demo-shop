...
class DataBase
{
    ...
    function __construct(\PDO $dbh, $tableName)
    {
        $this->server = new Server;
        $this->dbh = $dbh;
        $this->tableName = $tableName;
        $this->paramsValues = array();
        $this->paramsColumn = array();
    }
     ...
     * @return $this|string
     */
    public function updateSql($paramsColumn = array(), $paramsValues = array()) {
     ...
     * @return $this|string
     */
    public function insertSql($paramsColumn = array(), $paramsValues = array()) {
     ...
     */
    public function createTableSql($paramsColumn = array(), $paramsType = array()) {
     ...
     * @return bool
     */
    protected function checkCountArray($paramsColumn = array(), $paramsValues = array()) {
